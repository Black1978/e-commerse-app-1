            ...
            <div className='col'>
                <div className='row'>
                    <Link to='/products/5' className='link'>
                        <button className='button'>Electrical tubes</button>
                        <img src='/img/categories/cabinetes.jpg' alt='' />
                    </Link>
                </div>
                <div className='row'>
                    <Link to='/products/1' className='link'>
                        <button className='button'>Growing</button>
            ...
            <div className='col'>
                <div className='row'>
                    <Link to='/products/3' className='link'>
                        <button className='button'>Lastic junction</button>
                    ...
                    <div className='col'>
                        <div className='row'>
                            <Link to='/products/4' className='link'>
                                <button className='button'>Outlets</button>
